...
namespace JavaReact\EasyPush\drive;

use JavaReact\EasyPush\sdk\geTui\IGeTui;
use JavaReact\EasyPush\sdk\geTui\igetui\IGtAppMessage;
use JavaReact\EasyPush\sdk\geTui\igetui\template\IGtNotificationTemplate;
use JavaReact\EasyPush\sdk\geTui\igetui\IGtSingleMessage;
use JavaReact\EasyPush\sdk\geTui\igetui\IGtTarget;

class GeTuiService extends \JavaReact\EasyPush\core\BasePush implements \JavaReact\EasyPush\core\PushInterface
{
    protected $config = [];
    protected $AppID;
    protected $AppSecret;
